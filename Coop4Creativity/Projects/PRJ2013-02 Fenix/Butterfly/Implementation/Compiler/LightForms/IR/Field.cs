...
namespace LightForms.IR
{
    public class Field
    {
        /* _Name for ContentType field map. */
        ...
        /* TypeName for ContentType field map. */
        ...
        /**
         * Write the field map information to an XML element.
         */
        ...
        /**
         * Fuse the passed field map to this one.

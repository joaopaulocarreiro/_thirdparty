...
/**
 */
public class formManageEntity extends javax.swing.JFrame {

    /** Creates new form formBooking */
    public formManageEntity() {
        initComponents();
    }

    /** Action to quit the form. */
    @Action
    ...
    private void initComponents() {
        ...
        org.jdesktop.application.ResourceMap resourceMap = org.jdesktop.application.Application.getInstance(walkin.Main.class).getContext().getResourceMap(formManageEntity.class);
        ...
        javax.swing.ActionMap actionMap = org.jdesktop.application.Application.getInstance(walkin.Main.class).getContext().getActionMap(formManageEntity.class, this);

...
public class teste3
{
    ...
    public static void main(String args[]) 
	{
       ...
       Function[] functions = {new mul(),new add(),new sub(),new pdiv()}; 
       Terminal[] terminals = {x,erc};        
       
       /* criação das dunçoes de fitness */
       errorFitness err_fitness = new errorFitness(x);
       sizeStandardFitness std_fitness = new sizeStandardFitness();
